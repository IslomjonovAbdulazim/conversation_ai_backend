    ...
    try:
        ...
        return AddWordResponse(
            ...
            stats={
                ...
                "last_5_results": word_stats.last_5_results,
...
async def upload_photo_ocr(
    ...
    """
    OCR extract English words from photo and generate Uzbek translations
    """
    try:
        import time
        ...
        extracted_words = await extract_text_from_image(photo)
